...
Tutorial.PAGES = {
	...
	{ id = "plot", who = "all", title = "GETTING A PLOT",
	  lines = {
		"Walk onto an empty green square, open the menu, press MY PLOT, then",
		"press CLAIM. That plot is now yours. Build on it.",
		"",
		"YOU HAVE TO CLAIM BEFORE YOU BUILD. Ground nobody owns is open to",
		"nobody -- not you, not anyone else. Claiming is what opens it.",
		"",
		"Walk onto a plot somebody else owns and you get pushed off. Nothing",
		"pushes you off a free one, so you can stand there and press CLAIM.",
		"",
		"Scrap Mechanic has no per-player permission: a block is placeable by",
		"everybody or by nobody, so being pushed off IS the protection. An",
		"empty claimed plot is locked, so nobody can touch yours while away.",
		"",
		"FIND MY PLOT marks it on your compass. GIVE IT UP hands it back.",
	  } },

	{ id = "team", who = "all", title = "BUILDING WITH A FRIEND",
	  lines = {
		"Team up and you can build on the plots of everybody on your team, and",
		"on the strip of ground between them.",
		"",
		"Open MY PLOT and press TEAM UP WITH A NEIGHBOUR. You get the plots",
		"either side of yours and who owns each. Press ASK TO TEAM on one.",
		"THEY HAVE TO ASK YOU BACK -- their panel shows ACCEPT. Until both of",
		"you have pressed it, nothing changes.",
		"",
		"Only the plot in front, behind, left or right of yours. Never corner",
		"to corner, and never across a road: teaming hands over the strip",
		"between you, and there is no strip if a road is there.",
		"",
		"Teams chain: team your neighbour, they team theirs, all three share.",
		"LEAVE THE TEAM cuts your links and keeps your plot.",
	  } },
